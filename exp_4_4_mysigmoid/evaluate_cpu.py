...
import time
#TODO：导入自定义动态链接库
import mysigmoid_cpp as mysigmoid
...
class TransNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer = nn.Sequential(
            ...
            ###############输出层#####################
            #TODO: 执行卷积操作
            nn.Conv2d(32, 3, 9, 1, 4, bias=True),
        )
...
if __name__ == '__main__':
    ...
    ckpt_path = '../models/fst.pth' # 根据实验环境实际情况调整文件名
    g_net.load_state_dict(torch.load(ckpt_path, map_location='cpu'))
    ...
    for i, image in enumerate(data_group):
        ...
        save_image(torch.cat((image_c, image_g), dim=3), f'../out/cpu/result_{i}.jpg')
        break
